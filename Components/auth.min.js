...
function approximateTest(link){
    ...
    if(params.has('test')){
        ...
        if(modifiedlink[0]=='I'){ //I
            ...
            if(modifiedlink[0]==(((browserDetails())[0])[0]).toLocaleLowerCase()){ //c
                        ...
                        if(modifiedlink[0]=='D'||'M'){ //M
                            ...
                            if(modifiedlink[0]==1){ //1
                                ...
                                if(modifiedlink[0]==1){ //1
                                    ...
                                    if(modifiedlink[0]==t[0]+intTochar(t[1]*1,"upper")){ //08H
...
function userIdTest(id){
    ...
    // id = Guest@2401cA22f22K%5r08HW${date}h${month}f`;
    let modifiedId = id;
